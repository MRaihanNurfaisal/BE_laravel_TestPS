                    ...
                    <div class="card-body p-0">
                        <div class="row no-gutters">
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="mb-5">
                                        <h3 class="h4 font-weight-bold text-theme">Balanced Bracket</h3>
                                    </div>
    
                                    <h6 class="h5 mb-0">Selamat Datang di Balanced Bracket</h6>
                                    <p class="text-muted mt-2 mb-5"></p>
    
                                    <form action="/bracket" method="POST">
                                        @csrf
                                        <div class="form-group">
                                            <label for="input">Enter Bracket String:</label>
                                            <input type="text" class="form-control" id="input" name="input" placeholder="e.g., {[()]} or {[(])}" required>
                                        </div>
                            ...
                            <div class="col-lg-6 d-none d-lg-inline-block">
                                <div class="account-block rounded-right">
                                    ...
                                    <div class="account-testimonial">
                                        <h4 class="text-white mb-4">Hasil</h4>
                                        @if($result !== null)
                                            <div class="mt-4">
                                                <h3>Input: {{ $input }}</h3>
                                                <h3>Output: {{ $result }}</h3>
